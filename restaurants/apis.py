...
from restaurants.models import Restaurant, Meal, Order, OrderDetails, Driver
from restaurants.serializers import RestaurantSerializer, MealSerializer, OrderSerializer
